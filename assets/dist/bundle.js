...
exports.darkModeSupport = exports.heroAnimation = exports.smoothScrolling = exports.stickyHeader = void 0;
  ...
  if (forcedMode) {
    switch (forcedMode) {
      ...
      case 'system':
        ...
        } catch (err) {// localStorage not available. mode won't be persisted
        }
